...
import type { FurnitureConfig, HouseConfig } from '@/types/house'
...
type Props = {
  house: HouseConfig
  /** Overrides JSON furniture when provided (Zustand placements). */
 ...
 */
export function InteriorShell({ house, furniture }: Props) {
  const materials = useInteriorShellMaterials()
  const items = furniture ?? house.furniture ?? []
